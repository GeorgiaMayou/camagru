  ...
  function chooseimg(){
    ...
    choose.forEach(function(element){
        ...
        if (image && videoflag === 1){
            if (image.src === "http://localhost:8080/filter_images/1.png"){
                context.drawImage(image, 0, 0, 400, 300);
            }
            else if (image.src === "http://localhost:8080/filter_images/2.png"){
                context.drawImage(image, 0, 0, 400, 300);
            }
            else if (image.src === "http://localhost:8080/filter_images/3.png"){
                context.drawImage(image, 0, 0, 400, 300);
            }
            else if (image.src === "http://localhost:8080/filter_images/4.png"){
                context.drawImage(image, 0, 0, 400, 300);
            }
            else if (image.src === "http://localhost:8080/filter_images/5.png"){
                context.drawImage(image, 30, 60, 400, 300);
            }
            else if (image.src === "http://localhost:8080/filter_images/6.png"){
